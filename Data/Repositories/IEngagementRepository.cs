...
namespace gdsmx_back_netcoreAPI.Data.Repositories
{
    public interface IEngagementRepository
    {
        ...
        List<DataEmployeeEngagement> GetFile(int idEmployee, string GPN, string weeksBeforeEnd, int pageNumber, int rowsOfPage, bool isActive, object status, object employeeStatus, string employeeName);
    }
}
